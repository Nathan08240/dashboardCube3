...
<body class="flex justify-center items-center flex-col ">
    ...
    echo '<script>
            ...
            document.getElementById("sessions").classList.add("text-[#AFA5DA]");
        </script>';
    ?>
    <div class=" flex flex-col justify-center items-center w-full ">
        <div class="flex flex-col w-full items-center bg-[#afa5DA] mb-10">
            <div class="flex justify-center items-center my-6">
                ...
                <form action="sessions.php" method="POST" class="flex bg-[#afa5DA]  justify-center items-center bg-white  rounded-lg">
        ...
        <div class=" grid grid-cols-7 w-11/12 rounded-lg overflow-auto text-center">
            ...
            foreach ($sessions as $key => $session) {
                ...
                echo '<button class="h-11 flex justify-center items-center"  id="' . $session['ref'] . '"><iconify-icon icon="akar-icons:pencil" style="color: #afa5DA;" width="32" height="32"></iconify-icon></button>';
            ?>
                <script>
