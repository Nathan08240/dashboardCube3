        ...
        <div class=" p-2 rounded-lg flex flex-col justify-center items-center container ">
            <div class="flex flex-col w-full items-center">
                <div class ="flex justify-center items-center my-6">
                    <button class=" font-semibold p-2 flex justify-center items-center" id="add_student"><iconify-icon icon="akar-icons:person-add" style="color: #bada55;" width="32" height="32"></iconify-icon></button>
            ...
            <div class="w-full flex flex-col justify-center items-center" id="search_student">
                <div class=" grid grid-cols-5 w-11/12 rounded-lg overflow-auto ">
